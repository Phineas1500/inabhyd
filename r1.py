...
def parse_arguments():
    ...
    parser.add_argument("--model", type=str, required=True,
                        choices=["gpt", "llama", "gemmi", 'deepseek', 'dry', 'r1'])
...
if __name__ == "__main__":
    ...
    if is_open_ai:
        ...
        client = Together(
            api_key="tgp_v1_wKG4UWuvxrao5xZeuEPzGgSLrymMRP7gQsNeqwirhS4")
 ...
 """
    ...
    # .   Only output final hypotheses."""
                    ...
                    template = " Please come up with a set of hypotheses to explain observations. Put intermediate thinking process between <think> and </think>. Put only final hypotheses in the end without explanation."
